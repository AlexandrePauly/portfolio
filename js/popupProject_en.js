...
function showPopup(elt){
    ...
    const tabDesigns = ["Designs & Posters", "Creation of resumes, posters, and mobile or web interfaces using programming languages.", "Learning how to manage styles, tag positioning, new tools, etc.", "https://github.com/AlexandrePauly?tab=repositories", ["cv", "affiche1", "app_travel2", "interface", "cv"], ["html", "css", "js", 'angular'], ["HTML-CV", "slider", "XXXXX", "HTML-app-interface", "HTML-CV"]];
