...
function showPopup(elt){
    ...
    const tabForm = ["Forms", "Here you will find some forms I created for an E-commerce website.<br><br>Click on an image to try out the form.", "Taking my first steps in web development and building design skills.", "https://github.com/AlexandrePauly?tab=repositories", ["form-connexion", "form-contact4", "form-payment", "gift-card", "form-connexion"], ["html", "css", "js"], ["HTML-form-connexion", "html-form", "HTML-form-payment", "gift-card", "HTML-form-connexion"]];
    const tabPortfolio = ["Portfolio", "This is the site you are currently on.<br><br>Click on an image to display it in full size or click the button to access the source code and try it yourself.", "Learning how to create animations and improving my skills in web design (color theme choices, photos, photo editing, etc.). The goal was to develop a project from A to Z and host it.", "https://alexandrepauly.github.io/portfolio/", ["portfolio1", "portfolio6", "portfolio8", "portfolio10", "portfolio1"], ["html", "css", "js"], ["HTML-form-connexion", "html-form", "HTML-form-payment", "gift-card", "HTML-form-connexion"]];
    const tabCVAffiches = ["CV & Posters", "Creation of resumes, posters, and mobile interfaces using web languages.", "Learning how to manage styles and tag positioning.", "https://github.com/AlexandrePauly?tab=repositories", ["cv", "poster1", "poster2", "interface", "cv"], ["html", "css", "js"], ["HTML-CV", "slider", "slider", "HTML-app-interface", "HTML-CV"]];
    ...
    const tabTicTacToe = ["Tic-Tac-Toe", "The purpose of this project is to learn the Python language, from syntax manipulation to building an AI, and creating an interface.<br><br>Click on an image to display it in full size.", "Developing AI development skills.", "https://github.com/AlexandrePauly/Tic-Tac-Toe", ["tic-tac-toe1", "tic-tac-toe2", "tic-tac-toe3", "tic-tac-toe4", "tic-tac-toe1"], ["python"]];
    ...
    let tabContent = [tabWebSite,tabForm,tabPortfolio,tabCVAffiches,tabJavaFX,tabFingerprint,tabTicTacToe,tabEdgeDetection,tabMobileApp];
