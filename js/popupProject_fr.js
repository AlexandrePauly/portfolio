...
function showPopup(elt){
    ...
    const tabDesigns = ["Designs & Affiches","Réalisation de CV, d'affiches et d'interface mobile ou web en langages de programmation.","Apprendre à gérer les styles et le positionnement des balises, de nouveaux outils, etc.","https://github.com/AlexandrePauly?tab=repositories",["cv", "affiche1", "app_travel2", "interface", "cv"],["html", "css", "js", 'angular'],["HTML-CV","slider","XXXXX","HTML-app-interface","HTML-CV"]];
