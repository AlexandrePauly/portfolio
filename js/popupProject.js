...
function showPopup(elt){
    ...
    const tabCV = ["Curriulum Vitae","Réalisation d'un CV en langages web.","Apprendre à gérer les styles et le positionnement des balises.","https://alexandrepauly.github.io/HTML-CV/",["cv", "cv", "cv", "cv", "cv"],["html", "css", "js"],["HTML-CV","HTML-CV","HTML-CV","HTML-CV","HTML-CV"]];
