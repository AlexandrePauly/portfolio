...
function showPopup(elt){
    ...
    const tabCVAffiches = ["CV & Affiches","Réalisation de CV, d'affiches et d'interface mobile en langages web.","Apprendre à gérer les styles et le positionnement des balises.","https://github.com/AlexandrePauly?tab=repositories",["cv", "affiche1", "affiche2", "interface", "cv"],["html", "css", "js"],["HTML-CV","slider","slider","HTML-app-interface","HTML-CV"]];
